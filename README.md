...
<table>
  ...
  <tr>
    ...
    <details>
      <summary><b>어바웃 페이지</b></summary>
      <sub>• 서비스 소개 페이지</sub>
    </details>
    <details>
      <summary><b>반찬 목록</b></summary>
      <details>
        <summary><sub>카테고리 기능</sub></summary>
        <sub>• 정렬 기능</sub>
      </details>
      <details>
        <summary><sub>반찬 상세페이지</sub></summary>
        <sub>• 리뷰 리스트</sub>
      </details>
    </details>
    <details>
      <summary><b>주부 목록</b></summary>
      <details>
        <summary><sub>주부 상세페이지</sub></summary>
        <sub>• 주부 리뷰 리스트</sub>
      </details>
    </details>
    <details>
      <summary><b>주부 구독</b></summary>
      <details>
        <summary><sub>구독권 구매</sub></summary>
        <sub>• 구독 관리</sub>
      </details>
    </details>
    </td>
...
> 기능 구현을 넘어 설계와 협업까지 고민해볼 수 있었던 프로젝트였고, 팀원들과 함께 문제를 해결해가며 개발자로서 한 단계 성장할 수 있었던 뜻깊은 시간이었습니다!
